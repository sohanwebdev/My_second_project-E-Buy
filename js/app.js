$(function() {
    ...
    $('.count_down').countdown('2021/10/10', function (event) {
        var $this = $(this).html(event.strftime(''
            +'<div class="col-md-3"><div class="count_down_item"><span>%d</span><span>Days</span></div></div>'
            +'<div class="col-md-3"><div class="count_down_item"><span>%H</span><span>Hours</span></div></div>'
            +'<div class="col-md-3"><div class="count_down_item"><span>%M</span><span>Mins</span></div></div>'
            +'<div class="col-md-3"><div class="count_down_item"><span>%S</span><span>Sec</span></div></div>'));
    });
